    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('requisition_qunatity', models.PositiveIntegerField()),
                ('asset', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='user_history', to='core.asset')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='asset_history', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
